      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <?php echo form_open('Admin/daftarjudultodatabase'); ?>
              <?php
              ...
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="judul_tugas_akhir" name="judul_tugas_akhir" placeholder="Judul Tugas Akhir">
                  </div>
                </div>
