                    ...
                    <?php foreach($data->result() as $row):?>
                        <tr>
                          ...
                          <td><?php echo $row->judul_tugas_akhir;?></td>
                           <td>
                              <a href="<?php echo base_url().'berkasproposal/'.$row->nim.'/'.$row->berkas_proposal;?>" target="_blank"> <button type="button" class="btn  btn-warning"><?php echo $row->berkas_proposal;?></button> </a>
                          </td>
                          <td>
                            <?php echo form_open('Admin/seminarproposaltodatabase'); ?>
                              <input type="hidden" name="id_tugas_akhir" value="<?php echo $row->id;?>">
                              <button type="submit" class="btn btn-primary">Terima</button>
                            <?php echo form_close(); ?>
                            <a href="<?php echo base_url(); ?>Admin/editjudul/<?php echo $row->nim;?>" class="btn btn-default">Tolak</a>
